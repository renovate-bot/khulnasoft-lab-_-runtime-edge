...
The **@runtime-edge/vm** package is the low level bindings for creating Web Standard isolated VM contexts under the same [Khulnasoft Edge Functions](https://khulnasoft.com/edge) conditions.
