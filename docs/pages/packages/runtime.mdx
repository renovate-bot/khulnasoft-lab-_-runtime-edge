...
The **runtime-edge** package is a high-level, ready to use, general purpose way to run [Khulnasoft Edge Functions](https://khulnasoft.com/edge).
...
const response = await runtime.dispatchFetch(
  'http://khulnasoft.com?url=https://example.vercel.sh',
)
