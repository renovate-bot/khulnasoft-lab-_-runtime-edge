...
[Next.js](https://github.com/vercel/next.js/) is using [Runtime Edge](https://edge-runtime.vercel.app/) and the dependency is updated very often to get the latest changes.
