<div align="center">
  ...
  <br>
  <br>
  <p align="center"><strong>@runtime-edge/ponyfill</strong>: A ponyfill (doesn't overwrite the native methods) to use Runtime Edge APIs in any environment.</p>
...
**@runtime-edge/ponyfill** © [Khulnasoft](https://khulnasoft.com), released under the [MPLv2](https://github.com/khulnasoft/runtime-edge/blob/main/LICENSE.md) License.<br>
